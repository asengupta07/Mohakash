...
st.write("Copy and paste the following examples into the text area above to see how the tool works. You are welcome to mix and match any of the examples below or use your own logs to test the tool.")
